  ...
  <CollapseItem name="地图" :expanded="true">
    ...
    <SettingItemBox name="地理信息名称">
      <SettingItem name="显示">
        <n-space>
          <n-switch
            v-model:value="seriesList[1].label.show"
            size="small"
          ></n-switch>
        </n-space>
      </SettingItem>
    ...
    <SettingItemBox name="悬浮 （预览可见）">
      <SettingItem name="禁用">
        <n-space>
          <n-switch
            v-model:value="seriesList[1].emphasis.disabled"
            size="small"
          ></n-switch>
        </n-space>
      </SettingItem>
    ...
    <SettingItemBox name="悬浮弹窗">
      <SettingItem name="显示">
        <n-space>
          <n-switch
            v-model:value="seriesList[1].tooltip.show"
            size="small"
          ></n-switch>
        </n-space>
      </SettingItem>
  ...
  <CollapseItem name="标记" :expanded="true">
    ...
    <SettingItemBox name="文本">
      <SettingItem name="显示">
        <n-space>
          <n-switch
            v-model:value="seriesList[0].label.show"
            size="small"
          ></n-switch>
        </n-space>
      </SettingItem>
...
const initMapRegionOptions = () => {
  mapChinaJson.features.forEach((element) => {
