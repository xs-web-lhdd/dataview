<template>
  <div class="go-border-06">
    <svg xmlns="http://www.w3.org/2000/svg" :width="w" :height="h">
      ...
      <polygon
        class="stroke fill"
        :points="`15.5 ${h - 6.5} 20.5 ${h - 0.5} 50.5 ${h - 0.5} 55.5 ${
          h - 6.5
        } 15.5 ${h - 6.5}`"
      />
      <polygon
        class="stroke fill"
        :points="`${w - 15.5} 6.5 ${w - 20.5} 0.5 ${w - 50.5} 0.5 ${
          w - 55.5
        } 6.5 ${w - 15.5} 6.5`"
      />
      <polygon
        class="stroke fill"
        :points="`${w - 15.5} ${h - 6.5} ${w - 20.5} ${h - 0.5} ${w - 50.5} ${
          h - 0.5
        } ${w - 55.5} ${h - 6.5} ${w - 15.5} ${h - 6.5}`"
      />
      <polygon
        class="stroke fill"
        :points="`15.5 6.5 0.5 ${h / 2} 15.5 ${h - 6.5} ${w - 15.5} ${
          h - 6.5
        } ${w - 0.5} ${h / 2} ${w - 15.5} 6.5 15.5 6.5`"
      />
      <polyline
...
const { colors, dataset, textSize, textColor } = toRefs(
