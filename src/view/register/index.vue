  ...
  <div class="login">
    <div class="login-box">
      ...
      <div class="right">
        ...
        <el-form label-width="60px" :model="formLogin" size="default">
          <el-form-item label="账号" size="">
        ...
        <div class="opera">
          <div class="opera-btn">注册</div>
          <span class="opera-tip"
            >注册成功？<router-link to="/login">去登陆</router-link></span
          >
        </div>
      </div>
    </div>
